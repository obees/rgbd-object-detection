...
#from tf.keras import imagenet_utils
#from tf.keras.imagenet_utils import _obtain_input_shape
#from tf.keras.imagenet_utils import decode_predictions
...
def preprocess_input(x, **kwargs):
    ...
    # Returns
        Preprocessed array.
    """
    return tf.keras.imagenet_utils.preprocess_input(x, mode='tf', **kwargs)
...
def _se_block(inputs, filters, se_ratio, prefix):
    ...
    x = layers.Activation(hard_sigmoid,
